...
<html lang="en">
  <head>
    ...
    <title>GudangMusic</title>
  </head>
  <body>

    <nav class="navbar navbar-expand-lg p-3">
      <div class="container">
        <a class="navbar-brand wow bounceInDown" href="#"><h3>GudangMusic</h3></a>
        ...
        <div class="row">
          <div class="col-md-5">
            ...
            <p class="mb-4 wow fadeInLeft">
              Disini anda bisa menikmati lagu yg lagi hits,
              dan anda juga bisa menguplud lagu terbaru yg anda sukai.
            </p>
          ...
          <div class="col-md-7 mt-3">
            <img src="assets/svg/music.png" class="wow fadeInRight">
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row">
            <div class="col-lg-10 col-md-12 pt-0">
                <p>Copyright 2019 <a href="">GudangMusic</a> &copy; All Rights Reserved</p>
            </div>
